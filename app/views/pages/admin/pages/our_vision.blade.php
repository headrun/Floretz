...
<script type="text/javascript">
    ...
    $('#InsertButton').click(function(){
        ...
        if(data != ''){
            ...
            $.ajax({
                type: "POST",
                url: "{{URL::to('/quick/InsertVisionPageContent')}}",
...
<div id="page-wrapper">
        <?php $mainpage='pages'; $subpage='our_vision'; ?> 
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                   <div class="modal-header">
                        ...
                        <div class = "row">
                            <div class = "span12">
                                {{ Form::open(array('action' => 'AdminController@UploadMediaFromVision', 'files'=>true)) }}
                                    <div class = "col-md-2">
