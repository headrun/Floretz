...
<script type="text/javascript">
    ...
    $('#InsertButton').click(function(){
        ...
        if(data != ''){
            ...
            $.ajax({
                type: "POST",
                url: "{{URL::to('/quick/InsertmontessoriPageContent')}}",
...
@section('mainsub')
<div id="page-wrapper">
        <?php $mainpage='pages'; $subpage='montessori'; ?>  
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                   <div class="modal-header">
                        ...
                        <div class = "row">
                            <div class = "span12">
                                {{ Form::open(array('action' => 'AdminController@UploadMediaFromMontessori', 'files'=>true)) }}
                                    <div class = "col-md-2">
