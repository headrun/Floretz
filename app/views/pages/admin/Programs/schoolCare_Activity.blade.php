...
<div id="page-wrapper">
        <?php $mainpage='programs'; $subpage='schoolCare_Activity'; ?>    
		...
		<div class="main-page">
            <div class="row1">
                <div class="col-md-9 col-lg-12" style="background-color:#4F52BA;color:white; margin-bottom: 1em; padding: 3px;">
                    <h3>School Care & Activity Center</h3>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                   <div class="modal-header">
                        ...
                        <div class = "row">
                            <div class = "span12">
                                {{ Form::open(array('action' => 'AdminController@UploadMediaFromSchoolCare', 'files'=>true)) }}
                                    <div class = "col-md-2">
