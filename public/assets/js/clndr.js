...
(function (factory) {
  ...
  "<div style='background-color:#A9A9A9; color:white; height:40px; vertical-align:middle; text-align:center; font-size:15px;' class='header-day'>EVENTS OF THIS MONTH</div>"+
  "<% for( var i=0;i<eventsThisMonth.length;i++) { %>"+
        "<div>"+
            "<div class='panel panel-default'>"+
                "<div class='panel-heading'>"+
                    "<h4 class='panel-title' style = 'color: #4F52BA'>"+
                        "<a data-toggle='collapse' data-parent='#accordion' href='#collapse"+"<%= i %>'><span class = 'glyphicon glyphicon-arrow-right'></span>&nbsp;<%= eventsThisMonth[i].title %>&nbsp;&nbsp;<%= eventsThisMonth[i].eventstart %>&nbsp;&nbsp;to&nbsp;&nbsp;<%= eventsThisMonth[i].eventend %></a>"+
                    "</h4>"+
                "</div>"+
                "<div id='collapse"+"<%= i %>' class='panel-collapse collapse'>"+
                    "<div class='panel-body'><%=eventsThisMonth[i].description %></div>"+
                "</div>"+
            "</div>"+
        "</div>"+
  "<% } %>"+
